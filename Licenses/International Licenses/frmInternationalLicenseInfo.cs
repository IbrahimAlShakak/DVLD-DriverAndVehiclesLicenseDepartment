    ...
    public partial class frmInternationalLicenseInfo : Form
    {
        ...
        private void frmInternationalLicenseInfo_Load(object sender, System.EventArgs e)
        {
            if(_InternationalLicenseID != -1)
            {
                ...
                lblName.Text = InternationalLicense.Applicant.FullName;
                ...
                lblNationalNo.Text = InternationalLicense.Applicant.NationalNo;
                lblGender.Text = InternationalLicense.Applicant.Gender == 0 ? "Male" : "Female";
                ...
                lblDateOfBirth.Text = InternationalLicense.Applicant.DateOfBirth.ToString("dd/MM/yyyy");
